...
// game calls once a frame while the mouse is held, with an object saying
// where the cursor is (x, y), where it was last frame (px, py), whether this
// is the first frame of the stroke, and the radius and material set in the
// panel.
