...
-- boils water into steam (see steam.lua) and is put out by it.

local fire = sandy.material {
    name = "Fire",
    color = { 255, 140, 40 },
...
-- Water puts it out on contact. What that does to the water is in steam.lua.
